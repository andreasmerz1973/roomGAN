...
class TransferModel(BaseModel):
    ...
    def backward_G(self):
        ...
        if self.opt.use_cxloss:
            ...
            vgg_style = self.vgg(self.input_P1, style_layer)
        ...
        if self.opt.L1_type == 'l1_plus_perL1' :
            losses = self.criterionL1(self.fake_p2, self.input_P1, self.input_P2)
            self.loss_G_L1 = losses[0]
            self.loss_originL1 = losses[1].data
            self.loss_perceptual = losses[2].data
            self.loss_perceptual_target = losses[3].data
    ...
    def get_current_errors(self):
        ...
        if self.opt.L1_type == 'l1_plus_perL1':
            ...
            ret_errors['perceptual_target'] = self.loss_perceptual_target
    ...
    def get_current_visuals(self):
        ...
        #TODO: Change way layout is displayed in the results
        input_BP1 = util.draw_semantic_from_map(self.input_BP1.data)
        input_BP2 = util.draw_semantic_from_map(self.input_BP2.data)
