...
image_folder_1 = '/mnt/gpid08/users/jorge.pueyo/ADEChallengeData2016_original/bedroom_resize/masks'
image_folder_2 = '/mnt/gpid08/users/jorge.pueyo/ADEChallengeData2016/bedroom_resize/masks'
layout_folder = '/mnt/gpid08/users/jorge.pueyo/ADEChallengeData2016_original/bedroom_resize/layout'
images = {}
...
df.to_csv(os.path.join(save_folder, 'ade_pair_list.csv'), index = False)
